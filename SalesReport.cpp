...
int main()
{
    ...
    int units[NUM_PRODS] = {842, 416, 127, 514, 437, 269, 
                            97, 492, 212};
    ...
    // Sort the elements in the sales arrray in descending 
    ...
    // Display the products and sales amount. 
    showOrder(sales, id, NUM_PRODS);

    // Display total units sod and total sales. 
...
// price. The results is stored in the sales array. 
// *************************************************************
...
// **********************************************************************
// Definiton of showTotals function. Accepts sales and id arrays.       *
// as arguments. The size of the array is passed into num.              *
// The function first calcualtes the total units (of all products) sold *
// and the total sales. It then displays these amounts.                 *
// **********************************************************************
