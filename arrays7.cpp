...
int main()
{
    const int SIZE1 = 8; // Size of set1 arrray
    const int SIZE2 = 5; // Size of set2 array

    int set1[SIZE1]={2, 10, 15, 20, 25, 30, 35, 40};
...
This function accepts an array of integers and the array's
size as its arguments. The contents of the array are displayed.
******************************************************/
