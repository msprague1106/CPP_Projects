// This program gets a series of test socres and 
...
int main()
{
    ...
    double testScores[SIZE],  // Array of test scores
           total,           // Total of the test scores
...
//**********************************************************************
// The getTestScores funcion accepts an array and its size. 
...
/*********************************************************************
 * The getTotal function accepts a double array and tis size as agruments. The sum of the array's elements is returned as a double.  
 **********************************************************************/
 ...
 /********************************************************************
  * The getLowest function accepts a double array and its size as 
  * agruments. The lowest value in the array is returned as a double.
  ********************************************************************/
  ...
  double getLowest(const double numbers[], int size)
  {
    ...
    // step through the rest of the array. When a value less than lowest
    // is found, assign it to the lowest. 
