...
/***************************************************************
The getTestScores function accepts an array and its size as
arguments. It prompts the user to enter test scores, which are
stored in the array. 
******************************************************************/
...
/*****************************************************************
The getTotal function accepts a double array and its size as
arguments. The sum of teh array's elements is returned as double. 
*******************************************************************/
...
/******************************************************************
 ...
 arguments. The lowest value in the array is returned as a double.
 ******************************************************************/
...
double getLowest(const double numbers[], int size)
{
    ...
    // lowest is found, assign it to the lowest.
